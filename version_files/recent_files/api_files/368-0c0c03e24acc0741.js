  ...
  [368], {
    ...
    8764: function(t, e, r) {
      ...
      function S(t, e, r, n, i, o) {
        ...
        _(i, "offset"), (void 0 === n[i] || void 0 === n[i + o]) && C(i, n.length - (o + 1))
      }
      ...
      function C(t, e, r) {
        if (Math.floor(t) !== t) throw _(t, r), new T.ERR_OUT_OF_RANGE(r || "offset", "an integer", t);
    ...
    645: function(t, e) {
      ...
      e.read = function(t, e, r, n, i) {
        ...
        var f, u, s, h = 8 * o - i - 1,
          ...
          y = n ? 1 : -1,
          g = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (isNaN(e = Math.abs(e)) || e === 1 / 0 ? (u = isNaN(e) ? 1 : 0, f = a) : (f = Math.floor(Math.log(e) / Math.LN2), e * (s = Math.pow(2, -f)) < 1 && (f--, s *= 2), f + l >= 1 ? e += p / s : e += p * Math.pow(2, 1 - l), e * s >= 2 && (f++, s /= 2), f + l >= a ? (u = 0, f = a) : f + l >= 1 ? (u = (e * s - 1) * Math.pow(2, i), f += l) : (u = e * Math.pow(2, l - 1) * Math.pow(2, i), f = 0)); i >= 8; t[r + c] = 255 & u, c += y, u /= 256, i -= 8);
    ...
    9578: function(t, e, r) {
      ...
      var n = function(t) {
        ...
        for (let r = 0; r < t.length; r++) {
          let n = t.charAt(r),
            i = n.charCodeAt(0);
          if (255 !== e[i]) throw TypeError(n + " is ambiguous");
          e[i] = r
        }
        let r = t.length,
          n = t.charAt(0),
        ...
        function f(t) {
          ...
          for (; t[o];) {
            ...
            let i = 0;
            for (let t = s - 1;
              (0 !== n || i < u) && -1 !== t; t--, i++) n += r * h[t] >>> 0, h[t] = n % 256 >>> 0, n = n / 256 >>> 0;
            if (0 !== n) throw Error("Non-zero carry");
            u = i, o++
          }
          let a = s - u;
          for (; a !== s && 0 === h[a];) a++;
          let l = new Uint8Array(f + (s - a)),
            p = f;
          for (; a !== s;) l[p++] = h[a++];
          return l
        }
          ...
          encode: function(e) {
            ...
            for (; u !== s;) {
              let t = e[u],
                n = 0;
              for (let e = h - 1;
                (0 !== t || n < f) && -1 !== e; e--, n++) t += 256 * a[e] >>> 0, a[e] = t % r >>> 0, t = t / r >>> 0;
