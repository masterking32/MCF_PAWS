      ...
      t.canGoNext = b, t.extractObject = function(e, t) {
        ...
        if (!n) {
          ...
          var C = v(t.touchObject, s),
            R = w.swipeLength;
          return !S && (0 === u && ("right" === C || "down" === C) || u + 1 >= Math.ceil(g / m) && ("left" === C || "up" === C) || !b(t) && ("left" === C || "up" === C)) && (R = w.swipeLength * d, !1 === f && p && (p(C), E.edgeDragged = !0)), !h && k && (k(C), E.swiped = !0), P = i ? x + T / j * R * M : c ? x - R * M : x + R * M, s && (P = x + R * M), E = a(a({}, E), {}, {
            touchObject: w,
            swipeLeft: P,
            trackStyle: O(a(a({}, t), {}, {
              left: P
